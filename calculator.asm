...
startmsg: db    "Calculator app, made by Khaled Hany, and abdelrahman hussein :$"
msg:    db      0dh,0ah,0dh,0ah,"1-Add",0dh,0ah,"2-Subtract",0dh,0ah,"3-Multiply",0dh,0ah,"4-Divide", 0Dh,0Ah,"5-Exit app", 0dh,0ah, '$'
